...
import com.liferay.servicebuilder.model.TypeModel;
...
/**
 * The base model implementation for the Type service. Represents a row in the &quot;ShoeServiceBuilder_Type&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TypeModelImpl extends BaseModelImpl<Type> implements TypeModel {
	 ...
	 */
	public static final String TABLE_NAME = "ShoeServiceBuilder_Type";

	public static final Object[][] TABLE_COLUMNS = {
		{"typeId", Types.VARCHAR}, {"name", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table ShoeServiceBuilder_Type (typeId VARCHAR(75) not null primary key,name VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table ShoeServiceBuilder_Type";

	public static final String ORDER_BY_JPQL = " ORDER BY type.typeId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY ShoeServiceBuilder_Type.typeId ASC";
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"typeId", (BiConsumer<Type, String>)Type::setTypeId);
			attributeSetterBiConsumers.put(
	...
	public Type cloneWithOriginalValues() {
		...
		typeImpl.setTypeId(this.<String>getColumnOriginalValue("typeId"));
	...
	public CacheModel<Type> toCacheModel() {
		...
		String typeId = typeCacheModel.typeId;

		if ((typeId != null) && (typeId.length() == 0)) {
			typeCacheModel.typeId = null;
		}
