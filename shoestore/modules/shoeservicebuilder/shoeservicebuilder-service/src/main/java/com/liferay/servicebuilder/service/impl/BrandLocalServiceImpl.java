...
import com.liferay.servicebuilder.service.base.BrandLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.liferay.servicebuilder.model.Brand",
...
public class BrandLocalServiceImpl extends BrandLocalServiceBaseImpl {
	public Brand addBrand(String name) {
		...
		brandLocalService.addBrand(brand);
